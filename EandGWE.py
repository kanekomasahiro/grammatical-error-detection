...
train_txt = "train.txt"
ssweV = 'EandGmodel/eandgVoc.pkl'
ssweM = 'EandGmodel/eandg.model'
state_model = "EandGmodel/eandg.sta"
vocab_dict = 'EandGmodel/eandgVocabDict.pkl'
...
uni_dict = pickle.load(open('source_target.pkl','rb')) # error patterns
...
def forward(x, tags, model):
    ...
    b = F.sum(F.clipped_relu(1-co+o, 1e999))
