...
from functions import fill_batch, take_len, make_dict, make_spell_miss_list
import numpy as np
import collections
from chainer import *
...
train_txt = "train.txt"
ssweV = 'SSWEmodel/ssweVoc.pkl'
ssweM = 'SSWEmodel/sswe.model'
state_model = "SSWEmodel/sswe.sta"
vocab_dict = 'SSWEmodel/ssweVocabDict.pkl'
...
def make_sequences(sentences, tag):
    ...
    tags = xp.reshape(tags[:,1:2], (len(tags)))
